...
define("WORDING_REGISTRATION_FIRST", "User's first name (please provide the users last name)");
define("WORDING_REGISTRATION_LAST", "User's last name (please provide the users first name)");
