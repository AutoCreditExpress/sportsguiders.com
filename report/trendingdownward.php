    ...
    <!-- END Forms Components Header -->
            ...
            <div class="block">
                ...
                <div class="block-title">
                    ...
                    <h2>Trending Downward</h2>
                </div>
                <!-- END Select Component Title -->

                <!-- Select Component Content -->
                <form action="<?php echo $webPath;?>inc/report/trendingdownward.php" method="post" class="form-horizontal form-bordered" >
...
<?php if($_GET['up']): ?>
    <script>
        $(document).ready(function()
        {
            ...
            $.bootstrapGrowl('<h4><strong>Success!</strong></h4> <p>You have added trending downward...</p>', {
                type: growlType,
                delay: 3000,
                allow_dismiss: true,
