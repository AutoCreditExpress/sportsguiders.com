        ...
        <div id="quickNavDiv" class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="padding-left:0px;padding-right:0px;">
            ...
            <div id="mobileQuickNav" style="cursor:pointer;padding-right:0px;display:none;">
                ...
                <div style="padding:5px;padding-top:15px;float:right;background:white;height:50px;">
                    <a href="#" style="color:red;text-decoration:none;font-weight:900;padding:0px 15px;">Week 11</a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8">
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">19%</div>
                    <div class="name">Danny	Amendola<span class="position">WR</span> <span class="team">Patriots</span></div>
                    <p class="desc">Amendola likely becomes the beneficiary of the injury to Julian Edelman and proved it with a big game this week. He should be owned in all formats as a Flex or even potentially a WR2.</p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">2%</div>
                    <div class="name">Mark Sanchez<span class="position">QB</span> <span class="team">Eagles</span></div>
                    <p class="desc">While not a great QB, history shows Sanchez is able to put up some decent fantasy numbers when given the chance. It looks he is getting the chance.	</p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">5%</div>
                    <div class="name">Jay Ajayi<span class="position">RB</span> <span class="team">Dolphins</span></div>
                    <p class="desc">In a season of injuries to stars, and considering Miller's recent rise to stardom, the more than capable Ajayi becomes an essential handcuff. Better safe than sorry.</p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">0%</div>
                    <div class="name">Zach Miller<span class="position">TE</span> <span class="team">Bears</span></div>
                    <p class="desc">He has come out of nowhere but is now "trending upwards". If you need a TE this late in the game, there is no reason not to pick up Miller. </p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">0%</div>
                    <div class="name">Case Keenum<span class="position">QB</span> <span class="team">Rams</span></div>
                    <p class="desc">Mercifully, Foles has been benched. Although there is no telling how well Case will perform, he cannot be worse from a fantasy perspective.</p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">2%</div>
                    <div class="name">Brock Osweiler<span class="position">QB</span> <span class="team">Broncos</span></div>
                    <p class="desc">There is a chance Peyton has to miss some time, leaving the door wide open for Mr. Osweiler. If you are in a 2 QB league and thin at the position, Brock just may be your guy.</p>
                </section>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
					...
					<h2 class="" style="color:#39404b;padding-bottom:7px;font-weight:bold;">Week 10</h2>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position qb wow fadeInLeft" onclick="showTP('qb');">
                        ...
                        <ol class="qbol">
                            <li>Kirk Cousins - 38.8</li>
                            <li>Ben Roethlisberger - 35.2</li>
                            <li>Jay Cutler - 34.2</li>
                            <li>Eli Manning - 27.6</li>
                            <li>Carson Palmer - 27.3</li>
                            <li>Joe Flacco - 27.2</li>
                            <li>Aaron Rodgers - 26.9</li>
                            <li>Cam Newton - 24.7</li>
                            <li>Tom Brady - 24.5</li>
                            <li>Derek Carr - 22.1</li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position wr wow fadeInUp"   onclick="showTP('wr');">
                        ...
                        <ol class="wrol">
                            <li>Antonio Brown - 34.9</li>
                            <li>Michael Floyd - 27.3</li>
                            <li>Brandin Cooks - 27.1</li>
                            <li>Martavis Bryant - 25.3</li>
                            <li>Doug Baldwin - 23.4</li>
                            <li>Odell Beckham Jr. - 20.4</li>
                            <li>Larry Fitzgerald - 18.5</li>
                            <li>Eric Decker - 17.5</li>
                            <li>Dwayne Harris - 17.2</li>
                            <li>Mike Evans - 17.1</li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position rb wow fadeInRight" onclick="showTP('rb');">
                        ...
                        <ol  class="rbol">
                            <li>Jeremy Langford - 39.7</li>
                            <li>Adrian Peterson - 36.3</li>
                            <li>Charcandrick West - 35.9</li>
                            <li>Matt Jones - 30.4</li>
                            <li>LeSean McCoy - 22.7</li>
                            <li>Lamar Miller - 21.5</li>
                            <li>Jonathan Stewart - 19.5</li>
                            <li>DeMarco Murray - 19.3</li>
                            <li>Todd Gurley - 18.8</li>
                            <li>LeGarrette Blount - 18.5</li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position wr wow fadeInLeft" onclick="showTP('te');">
                        ...
                        <ol class="teol">
                            <li>Zach Miller - 27.2</li>
                            <li>Rob Gronkowski - 21.8</li>
                            <li>Jordan Reed - 16.4</li>
                            <li>Brent Celek - 15.9</li>
                            <li>Gary Barnidge - 15.5</li>
                            <li>Justin Perillo - 14.3</li>
                            <li>Crockett Gillmore - 12.2</li>
                            <li>Greg Olsen - 12</li>
                            <li>Maxx Williams - 12</li>
                            <li>Richard Rodgers - 11.7</li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position k wow fadeInUp" onclick="showTP('k');">
                        ...
                        <ol class="kol">
                            <li>Cairo Santos - 20</li>
                            <li>Dustin Hopkins - 18</li>
                            <li>Josh Brown - 16</li>
                            <li>Chandler Catanzaro - 15</li>
                            <li>Robbie Gould - 13</li>
                            <li>Dan Carpenter - 12</li>
                            <li>Jason Myers - 12</li>
                            <li>Stephen Gostkowski - 11</li>
                            <li>Graham Gano - 10</li>
                            <li>Blair Walsh - 10</li>
                        </ol>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-md-4 text-center">
					...
					<h2 class="" style="color:#242a33;padding-bottom:7px;font-weight:bold;">Week 10</h2>
                ...
                <div class="col-xs-12 col-sm-6 col-md-8">
                    <section class="player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Sam<br>Bradford<span class="position"></span> <span class="team">Eagles</span></div>
                        <div class="row desc">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8">
                    <section class="stat player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Peyton<br>Manning<span class="position"></span> <span class="team">Broncos</span></div>
                        <div class="row desc">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Michael<br>Floyd<span class="position"></span> <span class="team">Cardinals</span></div>
                        <div class="row desc">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Julian<br>Edelman<span class="position"></span> <span class="team">Patriots</span></div>
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Foot</div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Landry<br>Jones<span class="position"></span> <span class="team">Steelers</span></div>
                        <div class="row desc">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Ryan<br>Mathews <span class="position"></span> <span class="team">Eagles</span></div>
                        <div class="row desc">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Brian<br>Hoyer <span class="position"></span> <span class="team">Texans</span></div>
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Concussion</div>
							<div class="col-xs-12 col-sm-3"><span style="font-weight:bold;opacity:1;">0-2 Weeks<span></div>
							<div class="col-xs-12 col-sm-3">Questionable</div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Concussion</div>
							<div class="col-xs-12 col-sm-3"><span style="font-weight:bold;opacity:1;">None<span></div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                        <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                            ...
                            <div class="name">Victor<br>Cruz <span class="position"></span> <span class="team">Giants</span></div>
                            <div class="row desc">
                        ...
                        <div class="stats wow fadeIn" style="margin-top:10px;">
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    ...
                                    <tr style="background:#01ad7f;">
                                        <th colspan="3" class="text-center" style="color:white;">Ben Roethlisberger, QB</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#01ad7f;">
                                        <th colspan="3" class="text-center" style="color:white;">Adrian Peterson, RB</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#01ad7f;">
                                        <th colspan="3" class="text-center" style="color:white;">Martavis Bryant, WR</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#01ad7f;">
                                        <th colspan="3" class="text-center" style="color:white;">Zach Miller, TE</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                        ...
                        <div class="stats wow fadeIn" style="margin-top:10px;">
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    ...
                                    <tr style="background:#d83435;">
                                        <th colspan="3" class="text-center" style="color:white;">Drew Brees, QB</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                     <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#d83435;">
                                        <th colspan="3" class="text-center" style="color:white;">Darren McFadden, RB</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#d83435;">
                                        <th colspan="3" class="text-center" style="color:white;">Brandon Marshall, WR</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#d83435;">
                                        <th colspan="3" class="text-center" style="color:white;">Greg Olson, TE</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <div class="fact text-center wow rubberBand">
                        ...
                        <span class="info">With 2 straight dominating weeks, Antonio Brown has regained the WR fantasy points lead for the season. Brown is on pace for a career-high of 1,826 yards, which is over 100 more than last year. </span>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="fact text-center wow rubberBand">
                        ...
                        <span class="info">Although at times it appeared they were giving the game away, the Detroit Lions came out victorious against the Packers this Sunday. Their first road win at Green Bay since 1991 officially ended the losing streak at 24 straight games. </span>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="fact text-center wow rubberBand">
                        ...
                        <span class="info">Diagnosed with cancer prior to this season, Don Cousins, father of Redskins QB Kirk, was finally able to make it to a game. He witnessed his son throw for 324 yards and 4 TDs, compiling a perfect passer rating of 158.3, the first perfect rating by any QB this season. Receiving a game ball from his son afterward was icing on the cake.</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 wow fadeInDown">
                ...
                <table class="stats table table-hover">
                    ...
                    <tbody>
                    <tr>
                        <th>1. Stephen Gostkowski</th>
                    </tr>
                    <tr>
                        <th>2. Brandon McManus</th>
                    </tr>
                    <tr>
                        <th>3. Josh Brown</th>
                    </tr>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-3">
                    <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                        ...
                        <span class="desc"><span style="font-weight:900;">4.</span> Cardinals</span>
                    </section>
                </div>
                ...
                <div class="col-xs-6 col-sm-3">
                    <section class="stat wow fadeInDown clearfix" data-wow-delay=".45s">
                        ...
                        <span class="desc"><span style="font-weight:900;">5.</span> Vikings</span>
                    </section>
					</div>
					<div class="col-xs-6 col-sm-3">
					<section class="stat wow fadeInDown clearfix" data-wow-delay=".45s">
                        ...
                        <span class="desc"><span style="font-weight:900;">6.</span> Packers</span>
                    </section>
                </div>
...
<div class="row">
    <div class="col-xs-12 text-center">
		<h2 class="" style="color:white;padding-bottom:7px;font-weight:bold;">Week 10</h2>
...
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
    <div class="game gameScore clearfix wow zoomInRight">
        ...
        <div class="helmet right win removeHelmet">
            ...
            <span class="score tightenScore">47</span>
        </div>
    </div>
</div>
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
