...
?>
    ...
    <section id="quickNavSection" class="row" style="margin-left:0px;margin-right:0px;">
        <div class="col-xs-12 col-sm-0 col-md-0 col-lg-2">
            ...
            <ul id="mobileQuickNavUl" style="display:none;width:100%;">
                ...
                <li class=""><div style="width:300px;margin:0px auto;"><a class="mobilequickNavLink" href="#standings"><img src="<?=$webPath?>images/quicknav/standings.png" style="height:30px;" alt="stand"> Standings</a></div></li>
            </ul>
        </div>
        <div id="fullNav" class="col-xs-10 col-sm-10 col-md-10 col-lg-8 text-center">
            <div class="wrapper" style="display:table;margin:0px auto;">
                <ul class="quickNavUl" style="display:none;">
        ...
        <div id="fullWeek" class="col-xs-0 col-sm-2 col-md-2 col-lg-2 text-center">
