        ...
        <div id="quickNavDiv" class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="padding-left:0px;padding-right:0px;">
            ...
            <div id="mobileQuickNav" style="cursor:pointer;padding-right:0px;display:none;">
                ...
                <div style="padding:5px;padding-top:15px;float:right;background:white;height:50px;">
                    <a href="#" style="color:red;text-decoration:none;font-weight:900;padding:0px 15px;">Week 1</a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8">
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    ...
                    <div class="name">Marcus Mariota<span class="position">QB</span> <span class="team">Titans</span></div>
                    <p class="desc">The rookie passed for 4 TDs in the first half, he should be owned in every league as a solid backup and potential starter.</p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">11</div>
                    <div class="name">Alex Smith<span class="position">QB</span> <span class="team">Chiefs</span></div>
                    <p class="desc">With weapons like Kelce and Maclin, it's clear this game manager is clearly going to be throwing more this year.</p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">89</div>
                    <div class="name">James Jones<span class="position">WR</span> <span class="team">Packers</span></div>
                    <p class="desc">He's back, and Aaron Rodgers loves him in the red zone. Jones scored 2 TDs and hauled in over 50 yards.</p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">33</div>
                    <div class="name">Dion Lewis<span class="position">RB</span> <span class="team">Patriots</span></div>
                    <p class="desc">Totaling 120 yards, the Patriots use Dion much more than expected. He's worth a pick up as a potential flex play.</p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">87</div>
                    <div class="name">Austin Seferian-Jenkins<span class="position">TE</span> <span class="team">Buccaneers</span></div>
                    <p class="desc">Winston felt safe dumping the ball down to his TE this week, if that continues Austin SJ will be a nice addition to your team.</p>
                </section>
				<section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">85</div>
                    <div class="name">Darren Fells<span class="position">TE</span> <span class="team">Cardinals</span></div>
                    <p class="desc">Fells caught 4 passes for big chunks on Sunday, and added a 17 yard TD in the 4th quarter. He's an exciting new option at TE.</p>
                </section>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position qb wow fadeInLeft" onclick="showTP('qb');">
                        ...
                        <ol class="qbol">
                            <li>Tom Brady - 36.1</li>
                            <li>Marcus Mariota - 34.7</li>
                            <li>Carson Palmer - 34.2</li>
                            <li>Alex Smith - 31.4</li>
                            <li>Aaron Rodgers - 30.5</li>
                            <li>Tony Romo - 28.8</li>
                            <li>Philip Rivers - 25.2</li>
                            <li>Andy Dalton - 23.5</li>
                            <li>Andrew Luck - 22.4</li>
                            <li>Nick Foles - 21.7</li>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position wr wow fadeInUp"   onclick="showTP('wr');">
                        ...
                        <span class="TPmobileClickNotification">Click Here</span>
                        <ol class="wrol">
                            <li>Julio Jones - 31.1</li>
                            <li>DeAndre Hopkins - 28.3</li>
                            <li>Keenan Allen - 24.6</li>
                            <li>Antonio Brown - 24.3</li>
                            <li>Kendall Wright - 20.1</li>
                            <li>James Jones - 19.1</li>
                            <li>Percy Harvin - 19</li>
                            <li>Travis Benjamin - 17.9</li>
                            <li>Stevie Johnson - 17.2</li>
                            <li>Jarvis Landry - 16.9</li>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position rb wow fadeInRight" onclick="showTP('rb');">
                        ...
                        <span class="TPmobileClickNotification">Click Here</span>
                        <ol  class="rbol">
                            <li>Carlos Hyde - 36.9</li>
                            <li>Matt Forte - 30.4</li>
                            <li>Chris Ivory - 26.5</li>
                            <li>Bishop Sankey - 24</li>
                            <li>Danny Woodhead - 22.6</li>
                            <li>Jeremy Hill - 22.1</li>
                            <li>Jamaal Charles - 22</li>
                            <li>Eddie Lacy - 20.7</li>
                            <li>Ameer Abdullah - 18.8</li>
                            <li>Marshawn Lynch - 18.5</li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position wr wow fadeInLeft" onclick="showTP('te');">
                        ...
                        <span class="TPmobileClickNotification">Click Here</span>
                        <ol class="teol">
                            <li>Rob Gronkowski - 29.9</li>
                            <li>Tyler Eifert - 27.4</li>
                            <li>Travis Kelce - 26.6</li>
                            <li>Austin Seferian-Jenkins - 26.5</li>
							<li>Jason Witten - 22</li>
                            <li>Darren Fells - 16.2</li>
                            <li>Ladarius Green - 15.9</li>
                            <li>Jordan Reed - 15.8</li>
                            <li>Jimmy Graham - 14.1</li>
                            <li>Martellus Bennet - 14</li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position k wow fadeInUp" onclick="showTP('k');">
                        ...
                        <span class="TPmobileClickNotification">Click Here</span>
                        <ol class="kol">
                            <li>Brandon McManus - 18</li>
                            <li>Matt Bryant - 17</li>
                            <li>Josh Brown - 17</li>
                            <li>Robbie Gould - 14</li>
                            <li>Zach Hocker - 14</li>
                            <li>Dan Carpenter - 11</li>
                            <li>Steven Hauschka - 11</li>
                            <li>Greg Zuerlein - 10</li>
                            <li>Justin Tucker - 10</li>
                            <li>Mike Nugent - 9</li>
                        </ol>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8">
                    <section class="player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Andre<br>Ellington<span class="position"></span> <span class="team">Cardinals</span></div>
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Knee 'Sprain'</div>
							<div class="col-xs-12 col-sm-3"><span style="font-weight:bold;opacity:1;">0-5 Weeks</span></div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-8">
                    <section class="stat player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Dwayne<br>Bowe
                            <span class="position"></span> <span class="team">Browns</span></div>
                        <div class="row desc">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Head</div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Dez<br>Bryant<span class="position"></span> <span class="team">Cowboys</span></div>
                        <div class="row desc">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">CJ<br>Anderson <span class="position"></span> <span class="team">Broncos</span></div>
                        <div class="row desc">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Demarius<br>Thomas <span class="position"></span> <span class="team">Broncos</span></div>
                        <div class="row desc">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Ty<br>Hilton <span class="position"></span> <span class="team">Colts</span></div>
                        <div class="row desc">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Derek<br>Carr <span class="position"></span> <span class="team">Raiders</span></div>
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Hand</div>
							<div class="col-xs-12 col-sm-3"><span style="font-weight:bold;opacity:1;">0-2 Weeks<span></div>
							<div class="col-xs-12 col-sm-3">Questionable</div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Delanie<br>Walker <span class="position"></span> <span class="team">Titans</span></div>
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Hand</div>
							<div class="col-xs-12 col-sm-3"><span style="font-weight:bold;opacity:1;">0-2 Weeks<span></div>
							<div class="col-xs-12 col-sm-3">Questionable</div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">DeSean<br>Jackson <span class="position"></span> <span class="team">Redskins</span></div>
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Hamstring</div>
							<div class="col-xs-12 col-sm-3"><span style="font-weight:bold;opacity:1;">3-4 Weeks<span></div>
							<div class="col-xs-12 col-sm-3">Doubtful</div>
                        </div>
                    </section>
                </div>
                        ...
                        <div class="stats wow fadeIn" style="margin-top:10px;">
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    ...
                                    <tr style="background:#465366;">
                                        <th colspan="4" class="text-center" style="color:white;">Carson Palmer, QB</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="4" class="text-center" style="color:white;">Chris Ivory, RB</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="4" class="text-center" style="color:white;">Kendall Wright, WR</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="4" class="text-center" style="color:white;">Tyler Eifert, TE</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                        ...
                        <div class="stats wow fadeIn" style="margin-top:10px;">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="4" class="text-center" style="color:white;">Frank Gore, RB</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="4" class="text-center" style="color:white;">Calvin Johnson, WR</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="4" class="text-center" style="color:white;">Greg Olson, TE</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <div class="fact text-center wow rubberBand">
                        ...
                        <span class="info">Teddy Bridgewater led the league in red zone completion percentage last year at 72%, and also led the league in 3rd down completion percentage at 68.5%.</span>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="fact text-center wow rubberBand">
                        ...
                        <span class="info">American Football grew out of English sports such as rugby and soccer and became popular on American college campuses in the late 1800s.</span>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="fact text-center wow rubberBand">
                        ...
                        <span class="info">Ndamukong Suh has a foundation and is one of the most charitable  players in the league. He's given 2.6 million back to Nebraska and has a strength and conditioning center named after him.</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 wow fadeInDown">
                <table class="stats table table-hover">
                    ...
                    <tr>
                        <th>4. Ben Roethlisburger</th>
                    </tr>
                    <tr>
                        <th>5. Russell Wilson</th>
                    </tr>					
                    </tbody>
                </table>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-3 heading-col">
                    ...
                    <button type="button" class="info-icon" style="width:auto;" data-toggle="tooltip" data-placement="bottom" title="This isn't tennis. Nobody passes the ball to themselves and scores a touchdown. Offensive lines, defensive lines, and coaches matter too. Browse through our Team Power Ranking sections to know where the synergy is at and acquire players off these teams. They have something to play for. ">
                ...
                <div class="col-xs-6 col-sm-3">
                    <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                        ...
                        <span class="desc"><span style="font-weight:900;">3.</span> Seahawks</span>
                    </section>
                </div>
                ...
                <div class="col-xs-6 col-sm-3">
                    <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                        ...
                        <span class="desc"><span style="font-weight:900;">4.</span> Colts</span>
                    </section>
                </div>
                ...
                <div class="col-xs-6 col-sm-3">
                    <section class="stat wow fadeInDown clearfix" data-wow-delay=".45s">
                        ...
                        <span class="desc"><span style="font-weight:900;">5.</span> Cowboys</span>
                    </section>
                </div>
...
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
    <div class="game gameScore clearfix wow zoomInRight">
        ...
        <div class="helmet right loss removeHelmet">
            ...
            <span class="score tightenScore">9</span>
        </div>
    </div>
</div>
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
