...
<body yahoo="fix" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<!-- ======= main section ======= -->
	<table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="2b2e34" style="background-image: url(www.sportsguiders.com/email/subscription/signup/img/bg.png); background-size: 100% 100%; background-position: top center;" background="img/bg.png">
		
		<tr><td height="90" style="font-size: 90px; line-height: 90px;">&nbsp;</td></tr>
		
		<tr>
			<td>
				<table border="0" align="center" width="510" cellpadding="0" cellspacing="0" bgcolor="ffffff" class="container590 bodybg_color" style="border-top-left-radius: 4px; border-top-right-radius: 4px;">
				...
				<table border="0" align="center" width="510" cellpadding="0" cellspacing="0" bgcolor="ffffff" class="container590 bodybg_color">
					...
					<tr>
						...
						<td align="center" class="section-img">
							<a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="510" border="0" style="display: block; width: 510px;" src="www.sportsguiders.com/email/subscription/signup/img/main-img.png" alt="logo" /></a>
						</td>			
					</tr>
					...
					<tr>
						<td>
							<table border="0" width="440" align="center" cellpadding="0" cellspacing="0" class="container580">				
								<tr>
									<td align="center" style="color: #737b8c; font-size: 14px; font-family: 'Varela Round', sans-serif; mso-line-height-rule: exactly; line-height: 24px;" class="resize-text text_color">
										<div style="line-height: 24px">
                                            ...
                                            if($foundPlan){
                                               ...
                                               ?>
                                                <span style="color: #1c2029;">Congratulations</span>, you're now a member of SportsGuiders! To get access your account click the link below.
                                            <?php
                                            }?>
					...
					<tr>
						<td align="center">
							...
							<table border="0" align="center" width="220" cellpadding="0" cellspacing="0" bgcolor="red" style="border-radius: 50px; box-shadow: 0 1px 2px rgba(0,0,0,.3);" class="cta-button">
								...
								<tr>
	                				...
	                				<td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Varela Round', sans-serif;" class="cta-text">
		                    			...
		                    			<div style="line-height: 24px;">
			                    			<a href="//www.sportsguiders.com/my-account/" style="color: #ffffff; text-decoration: none;">Access Membership</a>
		                    			</div>
		                    		</td>
						...
						<td align="center" style="color: #b0b7c7; font-size: 14px; font-family: 'Questrial', sans-serif; mso-line-height-rule: exactly; line-height: 30px;" class="text_color">
							<div style="line-height: 30px">
								...
								<!-- ======= section text ======= -->
	        						...
	        						© 2015 SportsGuiders. All Rights Reserved.
