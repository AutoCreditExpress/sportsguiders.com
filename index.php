...
<!-- End Revolution Slider -->
    ...
    <section id="welcome" class="welcome section-primary">
        <!-- Welcome Container -->
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-8 col-md-6" style="padding-bottom: 50px;padding-top:50px;">
                    ...
                    <div class="content wow fadeInUp animated" style="visibility: visible;">
                        <!-- Welcome Header -->
                        <header>
                            <h4 style="font-size:48px;color:white;">Your Weekly <b style="color:#d83435;">Playbook</b>
                            </h4>
                            <h3 style="color:white;">Our weekly Playbook will save you time and help you win by providing you simplified information in an easy-to-read format at just the right time every week.</h3>
                            <hr class="hr-left">
                        </header>
                        <!-- End Welcome Header -->
                        <p style="color:white;">This Playbook is going to make your week so much easier! We provide you with only the high level information that matters, when it matters. We never try to bait you into clicking more links, and we will never show you an annoying slideshow. Our experts will curate a special report for you every week that will help you stay informed while maintaining a life outside of the game.</p>
                    </div>
                    <style>
                    ...
                    <p>
                        <a href="<?=$webPath;?>week11/" class="btn btn-lg btn-rounded btn-iconned redHover"><i class="fa fa-search fa-2x"></i> View Sample</a>
    ...
    <section class="page-heading animated bounceInLeft">
             ...
             <div class="row">
                    <div id="cutClutter" class="col-xs-12 col-md-6  wow fadeInUp animated" style="padding-bottom: 50px;padding-top:50px;">
                        ...
                        <p style="padding-top:10px;">
                            Our team of experts help you cut the informational clutter out of your life by preparing an easy-to-read Playbook that you will rely on every week. Your Weekly Playbooks contain only relevant content and useful information that is necessary to making winning decisions week in and week out.
                        </p>
                        <p>
                        ...
                        <p>
                            Every Tuesday we will send you an email. This email will notify you that Your Weekly Playbook is ready for you to view. You simply click the link, browse Your Weekly Playbook, and in less than 5 minutes you’re the most knowledgeable person in your league about last weeks’ games.
                        </p>
                        <p>
                            Forget the clutter, and the bouncing around, and sign up to receive Your Weekly Playbook today!
                        </p>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div id="saveTime" class="cols-xs-12 col-md-6  wow fadeInUp animated" style="padding-bottom: 50px;padding-top:50px;">
                    ...
                    <p>
                        Use Your Weekly Playbook to stay informed in the most simple way possible!
                    </p>
                </div>
