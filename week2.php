        ...
        <div id="quickNavDiv" class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="padding-left:0px;padding-right:0px;">
            ...
            <div id="mobileQuickNav" style="cursor:pointer;padding-right:0px;display:none;">
                ...
                <div style="padding:5px;padding-top:15px;float:right;background:white;height:50px;">
                    <a href="#" style="color:red;text-decoration:none;font-weight:900;padding:0px 15px;">Week 2</a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8">
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">17.8%</div>
                    <div class="name">Tyrod Taylor<span class="position">QB</span> <span class="team">Bills</span></div>
                    <p class="desc">It's time to take Tyrod Taylor seriously. Improving on his solid week 1 performance, Tyrod threw for 242 yards and had 3 total touchdowns in week 2.</p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">21.1%</div>
                    <div class="name">Andy Dalton<span class="position">QB</span> <span class="team">Bengals</span></div>
                    <p class="desc">Andy Dalton is getting it done. He put up 23.5 fantasy points in week 1 and 28.9 in week 2. With weapons like Sanu, Green, Jones and Eifert, he'll continue to put up strong numbers in 2015.</p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">15.8%</div>
                    <div class="name">Matt Jones<span class="position">RB</span> <span class="team">Redskins</span></div>
                    <p class="desc">Jones went from 6 rush attempts in week 1 to 19 rush attempts in week 2. He made the most of his increased workload and took 2 of those 19 attempts for TDs while tallying 123 total rush yards.</p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">6.3%</div>
                    <div class="name">Travis Benjamin<span class="position">WR</span> <span class="team">Browns</span></div>
                    <p class="desc">Benjamin builds on his week 1 performance by catching 2 bombs for long TDs compliments of Johnny Football. He's an exciting player that you can add to your bench with the hope of striking lightning on any given week.</p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">1.5%</div>
                    <div class="name">Crockett Gillmore<span class="position">TE</span> <span class="team">Ravens</span></div>
                    <p class="desc">Joe Flacco found his new favorite TE this Sunday. He hit Gillmore for 5 passes, 2 that went for TDs. Stash Gillmore away if you're in need of a backup TE, he could prove a solid option down the road.</p>
                </section>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position qb wow fadeInLeft" onclick="showTP('qb');">
                        ...
                        <ol class="qbol">
                            <li>Ben Roethlisberger - 37.2</li>
                            <li>Tom Brady - 35.8</li>
                            <li>Derek Carr - 34.7</li>
                            <li>Colin Kaepernick - 34.3</li>
                            <li>Cam Newton - 33.4</li>
                            <li>Tyrod Taylor - 32.9</li>
                            <li>Carson Palmer - 29.6</li>
                            <liRyan Tannehill - 29</li>
                            <li>Andy Dalton - 28.9</li>
                            <li>Russell Wilson - 28</li>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position wr wow fadeInUp"   onclick="showTP('wr');">
                        ...
                        <span class="TPmobileClickNotification">Click Here</span>
                        <ol class="wrol">
                            <li>Travis Benjamin - 34.5</li>
                            <li>Larry Fitzgerald - 33.7</li>
                            <li>Antonio Brown - 32.5</li>
                            <li>Allen Robinson - 31.5</li>
                            <li>Julian Edelman - 28.6</li>
                            <li>Odell Beckham Jr. - 26.1</li>
                            <li>Torrey Smith - 25</li>
                            <li>Emmanuel Sanders - 24.9</li>
                            <li>Amari Cooper - 22.4</li>
                            <li>Donte Moncrief - 22.2</li>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position rb wow fadeInRight" onclick="showTP('rb');">
                        ...
                        <span class="TPmobileClickNotification">Click Here</span>
                        <ol  class="rbol">
                            <li>DeAngelo Williams - 33.2</li>
                            <li>Matt Jones - 30.4</li>
                            <li>Adrian Peterson - 24.5</li>
                            <li>Dion Lewis - 22.2</li>
                            <li>Jamaal Charles - 21.4</li>
                            <li>Giovani Bernard - 19.9</li>
                            <li>Latavius Murray - 19.2</li>
                            <li>David Johnson - 18</li>
                            <li>Dexter McCluster - 16.4</li>
                            <li>Devonta Freeman - 16.3</li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position wr wow fadeInLeft" onclick="showTP('te');">
                        ...
                        <span class="TPmobileClickNotification">Click Here</span>
                        <ol class="teol">
                            <li>Crockett Gillmore - 23.3</li>
                            <li>Rob Gronkowski - 21.3</li>
                            <li>Anthony Fasano - 16.9</li>
                            <li>Tyler Eifert - 12.9</li>
							<li>Eric Ebron - 12.8</li>
                            <li>Richard Rodgers - 11.8</li>
                            <li>Kyle Rudolph - 11.5</li>
                            <li>Jordan Reed - 11.2</li>
                            <li>Larry Donnell - 10.8</li>
                            <li>Heath Miller - 10.5</li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position k wow fadeInUp" onclick="showTP('k');">
                        ...
                        <span class="TPmobileClickNotification">Click Here</span>
                        <ol class="kol">
                            <li>Stephen Gostkowski - 19</li>
                            <li>Mason Crosby - 16</li>
                            <li>Sebastian Janikowski - 15</li>
                            <li>Justin Tucker - 15</li>
                            <li>Kyle Brindza - 15</li>
                            <li>Robbie Gould - 14</li>
                            <li>Jason Myers - 13</li>
                            <li>Josh Brown - 9</li>
                            <li>Brandon McManus - 9</li>
                            <li>Andrew Franks - 9</li>
                        </ol>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8">
                    <section class="player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Tevin<br>Coleman<span class="position"></span> <span class="team">Falcons</span></div>
                        <div class="row desc">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8">
                    <section class="stat player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Jerricho<br>Cotchery
                            <span class="position"></span> <span class="team">Panthers</span></div>
                        <div class="row desc">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Jay<br>Cutler <span class="position"></span> <span class="team">Bears</span></div>
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Hamstring</div>
							<div class="col-xs-12 col-sm-3"><span style="font-weight:bold;opacity:1;">0-6 Weeks<span></div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Alshon<br>Jeffery<span class="position"></span> <span class="team">Bears</span></div>
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Hamstring</div>
							<div class="col-xs-12 col-sm-3"><span style="font-weight:bold;opacity:1;">0-2 Weeks<span></div>
							<div class="col-xs-12 col-sm-3">Questionable</div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Tony<br>Romo <span class="position"></span> <span class="team">Cowboys</span></div>
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Clavical</div>
							<div class="col-xs-12 col-sm-3"><span style="font-weight:bold;opacity:1;">8-10 Weeks<span></div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Jason<br>Witten <span class="position"></span> <span class="team">Cowboys</span></div>
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Ankle</div>
							<div class="col-xs-12 col-sm-3"><span style="font-weight:bold;opacity:1;">0-2 Weeks<span></div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Ribs/Arm</div>
							<div class="col-xs-12 col-sm-3"><span style="font-weight:bold;opacity:1;">0-2 Weeks<span></div>
							<div class="col-xs-12 col-sm-3">Probable</div>
                        </div>
                    </section>
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        <div class="helmet" style="width:65px;height:65px;background:#000000;">
                            <svg class="gb" version="1.0" xmlns="http://www.w3.org/2000/svg"
                             width="157.000000pt" height="150.000000pt" viewBox="0 0 257.000000 250.000000"
                             preserveAspectRatio="xMidYMid meet">
                                <g transform="translate(0.000000,150.000000) scale(0.100000,-0.100000)"
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Davante<br>Adams <span class="position"></span> <span class="team">Packers</span></div>
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Ankle</div>
							<div class="col-xs-12 col-sm-3"><span style="font-weight:bold;opacity:1;">0-2 Weeks<span></div>
							<div class="col-xs-12 col-sm-3">Questionable</div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        <div class="helmet" style="width:65px;height:65px;background:#4B92DB;">
                            <svg class="gb" version="1.0" xmlns="http://www.w3.org/2000/svg"
                             width="157.000000pt" height="150.000000pt" viewBox="0 0 257.000000 250.000000"
                             preserveAspectRatio="xMidYMid meet">
                                <g transform="translate(0.000000,150.000000) scale(0.100000,-0.100000)"
                        ...
                        <div class="name">Dwayne<br>Allen <span class="position"></span> <span class="team">Colts</span></div>
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Ankle</div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">DeNard<br>Robinson <span class="position"></span> <span class="team">Jaguars</span></div>
                        <div class="row desc">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Lamar<br>Miller <span class="position"></span> <span class="team">Dolphins</span></div>
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Ankle</div>
							<div class="col-xs-12 col-sm-3"><span style="font-weight:bold;opacity:1;">0-2 Weeks<span></div>
							<div class="col-xs-12 col-sm-3">Questionable</div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Jordan<br>Cameron <span class="position"></span> <span class="team">Dolphins</span></div>
                        <div class="row desc">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Drew<br>Brees <span class="position"></span> <span class="team">Saints</span></div>
                        <div class="row desc">
				...
				<div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Carlos<br>Hyde <span class="position"></span> <span class="team">49ers</span></div>
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Thigh</div>
							<div class="col-xs-12 col-sm-3"><span style="font-weight:bold;opacity:1;">0-2 Weeks<span></div>
							<div class="col-xs-12 col-sm-3">Questionable</div>
                        </div>
                    </section>
                        ...
                        <div class="stats wow fadeIn" style="margin-top:10px;">
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    ...
                                    <tr style="background:#465366;">
                                        <th colspan="4" class="text-center" style="color:white;">Ben Roethlisberger, QB</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="4" class="text-center" style="color:white;">Latavius Murray, RB</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="4" class="text-center" style="color:white;">Larry Fitzgerald, WR</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="4" class="text-center" style="color:white;">Larry Donnell, TE</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                        ...
                        <div class="stats wow fadeIn" style="margin-top:10px;">
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="4" class="text-center" style="color:white;">Sam Bradford, QB</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                     <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="4" class="text-center" style="color:white;">Jeremy Hill, RB</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="4" class="text-center" style="color:white;">Keenan Allen, WR</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="4" class="text-center" style="color:white;">Jimmy Graham, TE</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <div class="fact text-center wow rubberBand">
                        ...
                        <span class="info">Adrian Peterson has scored double-digit touchdowns every season of his career that he has played more than one game.	</span>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="fact text-center wow rubberBand">
                        ...
                        <span class="info">Wilson has been the exclusive maker of NFL footballs since 1941. They produce roughly 4,000 balls per day, or one for every Colts turnover.</span>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="fact text-center wow rubberBand">
                        ...
                        <span class="info">Alex Smith and Reggie Bush were high school teammates. The only two high school teammates to both be Heisman Trophy candidates.</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 wow fadeInDown">
                <table class="stats table table-hover">
                    ...
                    <tr>
                        <th>3. Ben Roethlisburger</th>
                    </tr>
                    <tr>
                        <th>4. Russell Wilson</th>
                    </tr>
                    <tr>
                ...
                <table class="stats table table-hover">
                    ...
                    <tr>
                        <th>4. Demarius Thomas</th>
                    </tr>
                    <tr>
                        <th>5. Randall Cobb</th>
                    </tr>					
                    </tbody>
                </table>
            ...
            <div class="col-xs-12 col-sm-4 wow fadeInDown">
                <table class="stats table table-hover">
                    ...
                    <tr>
                        <th>2. Tyler Eifert</th>
                    </tr>
                    <tr>
                        <th>3. Travis Kelce</th>
                    </tr>
                    <tr>
                        <th>4. Jimmy Graham</th>
                    </tr>
                    <tr>
                        <th>5.Greg Olsen</th>
                    </tr>					
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-3">
                    <section class="stat wow fadeInDown clearfix">
                        ...
                        <span class="desc"><span style="font-weight:900;">1.</span> Packers</span>
                    </section>
                </div>
                ...
                <div class="col-xs-6 col-sm-3">
                    <section class="stat wow fadeInDown clearfix">
                        ...
                        <span class="desc"><span style="font-weight:900;">2.</span> Patriots</span>
                    </section>
                </div>
                ...
                <div class="col-xs-6 col-sm-3">
                    <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                        ...
                        <span class="desc"><span style="font-weight:900;">3.</span> Steelers</span>
                    </section>
                </div>
                ...
                <div class="col-xs-6 col-sm-3">
                    <section class="stat wow fadeInDown clearfix" data-wow-delay=".45s">
                        ...
                        <span class="desc"><span style="font-weight:900;">6.</span> Cheifs</span>
                    </section>
                </div>
            </div>
        </div>
...
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
    <div class="game gameScore clearfix wow zoomInDown">
        ...
        <div class="helmet right win removeHelmet">
            <span class="city">PIT</span>
            <span class="score tightenScore">43</span>
        </div>
    </div>
</div>
...
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
    <div class="game gameScore clearfix wow zoomInRight">
        <div class="helmet left win removeHelmet">
            <span class="city">NE</span>
            <span class="score tightenScore">40</span>
        </div>
