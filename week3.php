        ...
        <div id="quickNavDiv" class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="padding-left:0px;padding-right:0px;">
            ...
            <div id="mobileQuickNav" style="cursor:pointer;padding-right:0px;display:none;">
                ...
                <div style="padding:5px;padding-top:15px;float:right;background:white;height:50px;">
                    <a href="#" style="color:red;text-decoration:none;font-weight:900;padding:0px 15px;">Week 3</a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8">
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">28.1%</div>
                    <div class="name">Rueben Randle<span class="position">WR</span> <span class="team">Giants</span></div>
                    <p class="desc">Looks like Randle is out of his funk which is good news for the Giants, and his fantasy owners. With the uncertain return of Victor Cruz, Randle could keep seeing targets and racking up points.</p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">24.1%</div>
                    <div class="name">Karlos Williams<span class="position">RB</span> <span class="team">Bills</span></div>
                    <p class="desc">Have you watched him run? Williams is one McCoy injury away from stardom. Grab him if you have a spare roster spot or are in need of a quality handcuff for trade bait.</p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">10.8%</div>
                    <div class="name">Allen Hurns<span class="position">WR</span> <span class="team">Jaguars</span></div>
                    <p class="desc">Hurns seems locked in as the #2 WR for the Jags and in deeper leagues could perform for you when needed during the BYE weeks. He's a true boom or bust play, but an exciting option nonetheless.</p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">29.2%</div>
                    <div class="name">Rishard Matthews<span class="position">WR</span> <span class="team">Dolphins</span></div>
                    <p class="desc">A lot of mouths to feed in Miami but Matthews has steadily performed. With 3 TDs and almost 300 yards in 3 weeks, he is someone to keep your eye on.</p>
                </section>
                <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                    <div class="number" style="margin-bottom:0px;">17.6%</div>
                    <div class="name">Charles Clay<span class="position">TE</span> <span class="team">Bills</span></div>
                    <p class="desc">Clay had a big week but might not be a one hit wonder. His favorable upcoming schedule could make Clay a solid TE option for those in desparate need.</p>
                </section>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position qb wow fadeInLeft" onclick="showTP('qb');">
                        ...
                        <ol class="qbol">
                            <li>Aaron Rodgers - 45.7</li>
                            <li>Andy Dalton - 39.2</li>
                            <li>Cam Newton - 35.8</li>
                            <li>Tyrod Taylor - 30.8</li>
                            <li>Matt Ryan - 28</li>
                            <li>Tom Brady - 27.5</li>
                            <li>Joe Flacco - 26.4</li>
                            <li>Derek Carr - 25</li>
                            <li>Josh McCown - 24.1</li>
                            <li>Peyton Manning - 23.9</li>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position wr wow fadeInUp"   onclick="showTP('wr');">
                        ...
                        <span class="TPmobileClickNotification">Click Here</span>
                        <ol class="wrol">
                            <li>A.J. Green - 42.2</li>
                            <li>Steve Smith Sr. - 39.1</li>
                            <li>Julio Jones - 35.4</li>
                            <li>Randall Cobb - 32</li>
                            <li>Keenan Allen - 31.8</li>
                            <li>Larry Fitzgerald - 30.4</li>
                            <li>Rishard Matthews - 27.3</li>
                            <li>Jeremy Maclin - 24.6</li>
                            <li>James Jones - 23.9</li>
                            <li>Rueben Randle - 22.1</li>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position rb wow fadeInRight" onclick="showTP('rb');">
                        ...
                        <span class="TPmobileClickNotification">Click Here</span>
                        <ol  class="rbol">
                            <li>Devonta Freeman - 46.3</li>
                            <li>Chris Johnson - 32.4</li>
                            <li>Joseph Randle - 32.3</li>
                            <li>LeGarrette Blount - 31.3</li>
                            <li>Jamaal Charles - 30.9</li>
                            <li>Adrian Peterson - 29.6</li>
                            <li>Latavius Murray - 27.1</li>
                            <li>Alfred Blue - 26.6</li>
                            <li>Le’Veon Bell - 26.5`</li>
                            <li>Frank Gore - 24.7</li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position wr wow fadeInLeft" onclick="showTP('te');">
                        ...
                        <span class="TPmobileClickNotification">Click Here</span>
                        <ol class="teol">
                            <li>Greg Olsen - 29.9</li>
                            <li>Gary Barnidge - 20</li>
                            <li>Jimmy Graham - 17.8</li>
                            <li>Charles Clay - 16.7</li>
							<li>Travis Kelce - 13</li>
                            <li>Rob Gronkowski - 12.6</li>
                            <li>Jordan Reed - 12.6</li>
                            <li>Clay Harbor - 11.8</li>
                            <li>Owen Daniels - 11.3</li>
                            <li>Delanie Walker - 103</li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                    <div class="position k wow fadeInUp" onclick="showTP('k');">
                        ...
                        <span class="TPmobileClickNotification">Click Here</span>
                        <ol class="kol">
                            <li>Stephen Gostkowski - 17</li>
                            <li>Steven Hauschka - 16</li>
                            <li>Josh Brown - 13</li>
                            <li>Dan Carpenter - 12</li>
                            <li>Graham Gano - 10</li>
                            <li>Sebastian Janikowski - 9</li>
                            <li>Mason Crosby - 9</li>
                            <li>Ryan Succop - 9</li>
                            <li>Travis Coons - 9</li>
                            <li>Chandler Catanzaro - 9</li>
                        </ol>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8">
                    <section class="stat player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Marshawn<br>Lynch<span class="position"></span> <span class="team">Seahawks</span></div>
                        <div class="row desc">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8" style="float:right;">
                    <section class="stat player wow fadeIn" style="padding-bottom:20px;border-bottom: 1px solid #d1d4d9;">
                        ...
                        <div class="name">Cody<br>Parkey <span class="position"></span> <span class="team">Eagles</span></div>
                        <div class="row desc">
							<div class="col-xs-12 col-sm-3">Groin</div>
							<div class="col-xs-12 col-sm-3"><span style="font-weight:bold;opacity:1;">IR<span></div>
							<div class="col-xs-12 col-sm-3">Out for Season</div>
                        </div>
                    </section>
                </div>
				<script>
                        ...
                        <div class="stats wow fadeIn" style="margin-top:10px;">
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    ...
                                    <tr style="background:#465366;">
                                        <th colspan="3" class="text-center" style="color:white;">Tyrod Taylor, QB</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="3" class="text-center" style="color:white;">Joseph Randle, RB</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="3" class="text-center" style="color:white;">Steve Smith, WR</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="3" class="text-center" style="color:white;">Greg Olsen, TE</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                        ...
                        <div class="stats wow fadeIn" style="margin-top:10px;">
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="3" class="text-center" style="color:white;">Matthew Staff., QB</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                     <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="3" class="text-center" style="color:white;">Jonathan Stew., RB</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="3" class="text-center" style="color:white;">Mike Wallace, WR</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                    <thead>
                                    <tr style="background:#465366;">
                                        <th colspan="3" class="text-center" style="color:white;">Martellus Benn., TE</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <div class="fact text-center wow rubberBand">
                        ...
                        <span class="info">Andrew Luck leads the NFL with 5 INTs on the season, even though Colin Kaepernick had 4 this week alone.	</span>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="fact text-center wow rubberBand">
                        ...
                        <span class="info">Fantasy Football can be traced as far back as 1962 with a league called the GOPPPL (Greater Oakland Professional Pigskin Prognosticators League).</span>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="fact text-center wow rubberBand">
                        ...
                        <span class="info">Michael Vick was drafted by the Colorado Rockies in the 30th round of the 2000 Major League Baseball draft.</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 wow fadeInDown">
                ...
                <table class="stats table table-hover">
                    ...
                    <tbody>
                    <tr>
                        <th>1. Adrian Peterson</th>
                    </tr>
                    <tr>
                        <th>2. Jamaal Charles</th>
                    </tr>
                    <tr>
                        <th>3. Le'Veon Bell</th>
                    </tr>
                    <tr>
                        <th>4. Eddie Lacy</th>
                    </tr>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-3">
                    <section class="stat wow fadeInDown clearfix" data-wow-delay=".25s">
                        ...
                        <span class="desc"><span style="font-weight:900;">3.</span> Cardinals</span>
                    </section>
                </div>
                ...
                <div class="col-xs-6 col-sm-3">
                    <section class="stat wow fadeInDown clearfix" data-wow-delay=".45s">
                        ...
                        <span class="desc"><span style="font-weight:900;">5.</span> Seahawks</span>
                    </section>
					</div>
					<div class="col-xs-6 col-sm-3">
					<section class="stat wow fadeInDown clearfix" data-wow-delay=".45s">
                        ...
                        <span class="desc"><span style="font-weight:900;">6.</span> Bengals</span>
                    </section>
                </div>
    ...
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
        <div class="game gameScore clearfix wow zoomInDown">
            <div class="helmet left win removeHelmet">
                <span class="city">BUF</span>
                <span class="score tightenScore">41</span>
            </div>
    ...
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
        <div class="game gameScore clearfix wow zoomInDown">
            <div class="helmet left loss removeHelmet">
                ...
                <span class="score tightenScore">0</span>
            </div>
...
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
    <div class="game gameScore clearfix wow zoomInRight">
        ...
        <div class="helmet right win removeHelmet">
            <span class="city">NE</span>
            <span class="score tightenScore">51</span>
        </div>
    </div>
</div>
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
