    ...
    <section id="injury-report" class="injury-report" style="padding:50px 15px;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8">
                    <?php foreach($Report->getInjuries() as $Injuries):; ?>
                        <?php $Player = $PlayerDAO->getPlayerFromID($Injuries->getPlayerID()) ?>
                            ...
                            <div class="helmet" style="width:65px;height:65px;">
                                <svg class="min" version="1.0" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <g transform="translate(0.000000,150.000000) scale(0.100000,-0.100000)"
                                       fill="<?php echo $TeamDAO->getTeamColor1ByTeamShortName($Player->getTeam());?>" stroke="none">
                                ...
                                <span class="city"><?php echo $Player->getTeam(); ?></span>
                            </div>

                            <div class="name"><?php echo $Player->getName(); ?><span class="position"></span> <span class="team"><?php echo $Player->getTeam(); ?></span></div>
                        <span class="desc">
                            <?php echo $Injuries->getDescription();?><b>Game Time Decision</b>
                        </span>
                        </section>
                ...
                <div class="row">
                    <div class="text-center">
                        ...
                        <div class="stats wow fadeIn">
                            ...
                            ?>
                            <?php foreach($Report->getTrendingUp() as $TrendingUp):; ?>
                                <?php $Player = $PlayerDAO->getPlayerFromID($TrendingUp->getPlayerID()) ?>
                                <div class="col-xs-12 col-sm-6">
                                    <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                        <thead>
                                        <tr style="background:#465366;">
                                            <th colspan="4" class="text-center" style="color:white;"><?php echo $Player->getName(); ?>-<?php echo $Player->getPosition();?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                        ...
                                        ?>
                                            <tr>
                                                <th>Week <?=$CurrentReportNumber;?></th>
                                                <td></td>
                                                <td><i class="fa fa-caret-up"></i></td>
                                                <td><?php echo $TrendingUp->getPoints();?></td>
                                            </tr>
                                        <?php
                                            if($counter==4){
                                                break;
            ...
            <section class="col-xs-12 col-sm-6 downwards">
                <div class="row">
                    <div class="text-center">
                        ...
                        <div class="stats wow fadeIn">
                            <?php foreach($Report->getTrendingDown() as $TrendingDown):; ?>
                                <?php $Player = $PlayerDAO->getPlayerFromID($TrendingDown->getPlayerID()) ?>
                                <div class="col-xs-12 col-sm-6">
                                    <table class="stats table table-hover" style="border:1px solid #d1d4d9;">
                                        <thead>
                                        <tr style="background:#465366;">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <div class="fact text-center wow rubberBand">
                        ...
                        <span class="info"><?php echo $FactsDAO->getFact($_GET['id'],'fantasy');?></span>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="fact text-center wow rubberBand">
                        ...
                        <span class="info"><?php echo $FactsDAO->getFact($_GET['id'],'history');?></span>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="fact text-center wow rubberBand">
                        ...
                        <span class="info"><?php echo $FactsDAO->getFact($_GET['id'],'life');?> </span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="team-rankings" class="team-rankings" style="padding:50px 15px;">
        <div class="container">
            <div class="row">
                ...
                <?php foreach($Report->getTeamPowerRanking() as $tpr): ?>
...
<div class="row">
<?php foreach($Report->getScores() as $Scores):; ?>
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
        <div class="game gameScore clearfix wow zoomInDown">
            <div class="helmet left <?php echo $ScoreDAO->checkScore1ForWinner($Scores['score_home'],$Scores['score_away']);?> removeHelmet">
                <span class="city"><?php echo $TeamDAO->getTeamFromID($Scores['score_home_team_id'])['team_short_name']?></span>
                <span class="score tightenScore"><?php echo $Scores['score_home'];?></span>
            </div>

            <div class="vs">AT</div>

            <div class="helmet right <?php echo $ScoreDAO->checkScore1ForWinner($Scores['score_away'],$Scores['score_home']);?> removeHelmet">
                <span class="city"><?php echo $TeamDAO->getTeamFromID($Scores['score_away_team_id'])['team_short_name']?></span>
                <span class="score tightenScore"><?php echo $Scores['score_away'];?></span>
            </div>
        </div>
    </div>
<?php endforeach; ?>
